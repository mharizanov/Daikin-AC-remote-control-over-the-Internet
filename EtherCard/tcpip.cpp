...
static const char *client_headersstr;
    ...
    if (client_postval == 0) {
      bfill.emit_p(PSTR("GET $F$S HTTP/1.1\r\n"
                        ...
                        "\r\n"), client_urlbuf,
                                 client_urlbuf_var,								 
                                 client_hoststr,
								 client_headersstr                //extra headers (if any)
								 );
...
void EtherCard::browseUrl (prog_char *urlbuf, const char *urlbuf_varpart,const char *headersstr, prog_char *hoststr,void (*callback)(byte,word,word)) {
  client_urlbuf = urlbuf;
  client_urlbuf_var = urlbuf_varpart;
  client_hoststr = hoststr;
  client_headersstr = headersstr;
  client_postval = 0;
